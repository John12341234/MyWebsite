            ...
            if (h) {
                f.find("*").andSelf().each(function () {
                    ...
                    if (k.is("img:uncached")) {
                        e.push({src: k.attr("src"), element: k[0]});
                    }
                    c.each(l, function (s, r) {
                        ...
                        while (t = g.exec(q)) {
                            e.push({src: t[2], element: k[0]});
                        }
                    });
                });
            } else {
                f.find("img:uncached").each(function () {
                    e.push({src: this.src, element: this});
                });
            }
            a = e.length;
            j = 0;
...
/*! pace 0.4.17 */
(function () {
    var aY, aX, aW, aV, aU, aT, aS, aR, aQ, aP, aO, aN, aM, aL, aK, aJ, aI, aH, aG, aF, aE, aD, aC, aB, aA, az, ay, ax, aw, av, au, at, ar, aq, ap, ao, an, am, al, ak, aj, ai, ah, ag, af, ae, ad, ac = [].slice, ab = {}.hasOwnProperty, aa = function (f, e) {
        function h() {
            this.constructor = f;
        }
    ...
    for (aF = {
    ...
    }, av = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, aG = window.cancelAnimationFrame || window.mozCancelAnimationFrame, null == av && (av = function (b) {
        return setTimeout(b, 50);
    }, aG = function (b) {
        return clearTimeout(b);
    }), at = function (e) {
        var d, f;
        return d = ax(), (f = function () {
            var a;
            return a = ax() - d, a >= 33 ? (d = ax(), e(a, function () {
                return av(f);
            })) : setTimeout(f, 33 - a);
        })();
    }, au = function () {
        ...
        var i, h, n, m, l, k, j;
        for (h = arguments[0], m = 2 <= arguments.length ? ac.call(arguments, 1) : [], k = 0, j = m.length; j > k; k++) {
            if (n = m[k]) {
                for (i in n) {
                    ab.call(n, i) && (l = n[i], null != h[i] && "object" == typeof h[i] && null != l && "object" == typeof l ? aE(h[i], l) : h[i] = l);
                }
            }
        }
        return h;
        ...
        return b.prototype.on = function (g, f, j, i) {
            ...
            if (p = arguments[0], r = 2 <= arguments.length ? ac.call(arguments, 1) : [], null != (l = this.bindings) ? l[p] : void 0) {
         ...
         ah > aj; aj++) {
        ap = af[aj], aw[ap] === !0 && (aw[ap] = aF[ap]);
    }
    aQ = function (d) {
        function c() {
            return ae = c.__super__.constructor.apply(this, arguments);
        }
        ...
        return b.prototype.getElement = function () {
            var c;
            if (null == this.el) {
                if (c = document.querySelector(aw.target), !c) {
                    throw new aQ;
                }
    ...
    }(), ak = window.XMLHttpRequest, al = window.XDomainRequest, am = window.WebSocket, aD = function (i, h) {
        var n, m, l, k;
        k = [];
        ...
        return k;
    }, az = [], Pace.ignore = function () {
        var e, d, f;
        return d = arguments[0], e = 2 <= arguments.length ? ac.call(arguments, 1) : [], az.unshift("ignore"), f = d.apply(null, e), az.shift(), f;
    }, Pace.track = function () {
        var e, d, f;
        return d = arguments[0], e = 2 <= arguments.length ? ac.call(arguments, 1) : [], az.unshift("track"), f = d.apply(null, e), az.shift(), f;
    }, aq = function (d) {
        var c;
        if (null == d && (d = "GET"), "track" === az[0]) {
            return "force";
        }
        if (!az.length && aw.ajax) {
            if ("socket" === d && aw.ajax.trackWebSockets) {
                return !0;
            }
            if (c = d.toUpperCase(), Z.call(aw.ajax.trackMethods, c) >= 0) {
                return !0;
            }
        }
        return !1;
        ...
        function c() {
            ...
            c.__super__.constructor.apply(this, arguments), b = function (g) {
                ...
                return f = g.open, g.open = function (h, a) {
                    return aq(h) && e.trigger("request", {type: h, url: a, request: g}), f.apply(g, arguments);
                };
            }, window.XMLHttpRequest = function (a) {
                var f;
                return f = new ak(a), b(f), f;
            }, aD(window.XMLHttpRequest, ak), null != al && (window.XDomainRequest = function () {
                var a;
                return a = new al, b(a), a;
            }, aD(window.XDomainRequest, al)), null != am && aw.ajax.trackWebSockets && (window.WebSocket = function (g, f) {
                var h;
                return h = new am(g, f), aq("socket") && e.trigger("request", {
                    type: "socket",
                    url: g,
                    protocols: f,
                    request: h
        ...
        return aa(c, d), c;
    }(aR), ai = null, aB = function () {
        return null == ai && (ai = new aP), ai;
    }, aB().on("request", function (a) {
        var j, i, h, g;
        return g = a.type, h = a.request, Pace.running || aw.restartOnRequestAfter === !1 && "force" !== aq(g) ? void 0 : (i = arguments, j = aw.restartOnRequestAfter || 0, "boolean" == typeof j && (j = 0), setTimeout(function () {
            var d, m, l, k, f, e;
            if (d = "socket" === g ? h.readyState < 2 : 0 < (k = h.readyState) && 4 > k) {
                for (Pace.restart(), f = Pace.sources, e = [], m = 0, l = f.length; l > m; m++) {
                    if (ap = f[m], ap instanceof aY) {
                        ap.watch.apply(ap, i);
                        break;
                    }
                    e.push(void 0);
        ...
        function b() {
            var c = this;
            this.elements = [], aB().on("request", function () {
                return c.watch.apply(c, arguments);
            });
        }

        return b.prototype.watch = function (f) {
            var e, h, g;
            return g = f.type, e = f.request, h = "socket" === g ? new aM(e) : new aL(e), this.elements.push(h);
        }, b;
    }(), aL = function () {
        function b(j) {
        ...
        function b(g) {
            ...
            for (null == g && (g = {}), this.elements = [], null == g.selectors && (g.selectors = []), h = g.selectors, j = 0, i = h.length; i > j; j++) {
                e = h[j], this.elements.push(new aU(e));
            }
        }
        ...
        function b() {
            ...
            this.progress = 0, h = 0, j = [], k = 0, l = ax(), g = setInterval(function () {
                var a;
                return a = ax() - l - 50, l = ax(), j.push(a), j.length > aw.eventLag.sampleCount && j.shift(), h = aJ(j), ++k >= aw.eventLag.minSamples && h < aw.eventLag.lagThreshold ? (i.progress = 100, clearInterval(g)) : i.progress = 100 * (3 / (h + 3));
            }, 50);
        }
        ...
        function b(c) {
            this.source = c, this.last = this.sinceLastUpdate = 0, this.rate = aw.initialRate, this.catchup = 0, this.progress = this.lastProgress = 0, null != this.source && (this.progress = au(this.source, "progress"));
        }

        return b.prototype.tick = function (e, d) {
            var f;
            return null == d && (d = au(this.source, "progress")), d >= 100 && (this.done = !0), d === this.last ? this.sinceLastUpdate += e : (this.sinceLastUpdate && (this.rate = (d - this.last) / this.sinceLastUpdate), this.catchup = (d - this.progress) / aw.catchupTime, this.sinceLastUpdate = 0, this.last = d), d > this.progress && (this.progress += this.catchup * e), f = 1 - Math.pow(this.progress / 100, aw.easeFactor), this.progress += f * this.rate * e, this.progress = Math.min(this.lastProgress + aw.maxProgressPerFrame, this.progress), this.progress = Math.max(0, this.progress), this.progress = Math.min(100, this.progress), this.lastProgress = this.progress, this.progress;
        }, b;
    }(), ao = null, ar = null, aI = null, an = null, aK = null, aH = null, Pace.running = !1, aA = function () {
        return aw.restartOnPushState ? Pace.restart() : void 0;
    }, null != window.history.pushState && (ag = window.history.pushState, window.history.pushState = function () {
        return aA(), ag.apply(window.history, arguments);
    }), null != window.history.replaceState && (ad = window.history.replaceState, window.history.replaceState = function () {
        return aA(), ad.apply(window.history, arguments);
    }), aO = {ajax: aY, elements: aV, document: aW, eventLag: aT}, (ay = function () {
        var b, p, o, n, m, l, k, j;
        for (Pace.sources = ao = [], l = ["ajax", "elements", "document", "eventLag"], p = 0, n = l.length;
             n > p; p++) {
            b = l[p], aw[b] !== !1 && ao.push(new aO[b](aw[b]));
        }
        for (j = null != (k = aw.extraSources) ? k : [], o = 0, m = j.length; m > o; o++) {
            ap = j[o], ao.push(new ap(aw));
        }
        return Pace.bar = aI = new aX, ar = [], an = new aN;
    })(), Pace.stop = function () {
        return Pace.trigger("stop"), Pace.running = !1, aI.destroy(), aH = !0, null != aK && ("function" == typeof aG && aG(aK), aK = null), ay();
    }, Pace.restart = function () {
        return Pace.trigger("restart"), Pace.stop(), Pace.start();
    }, Pace.go = function () {
        return Pace.running = !0, aI.render(), aH = !1, aK = at(function (L, K) {
            var J, I, H, G, F, E, D, C, B, A, z, y, x, w, r, q, l;
            for (C = 100 - aI.progress, I = y = 0, H = !0, E = x = 0, r = ao.length;
                 r > x; E = ++x) {
                for (ap = ao[E], A = null != ar[E] ? ar[E] : ar[E] = [], F = null != (l = ap.elements) ? l : [ap], D = w = 0, q = F.length; q > w; D = ++w) {
                    G = F[D], B = null != A[D] ? A[D] : A[D] = new aN(G), H &= B.done, B.done || (I++, y += B.tick(L));
                }
            }
            return J = y / I, aI.update(an.tick(L, J)), z = ax(), aI.done() || H || aH ? (aI.update(100), Pace.trigger("done"), setTimeout(function () {
                return aI.finish(), Pace.running = !1, Pace.trigger("hide");
            }, Math.max(aw.ghostTime, Math.min(aw.minTime, ax() - z)))) : K();
        });
    }, Pace.start = function (d) {
        aE(aw, d), Pace.running = !0;
        try {
            aI.render();
        } catch (c) {
            aQ = c;
...
(function () {
    ...
    (function (c, d) {
        ...
        B[C].settings = {resizeThrottle: 100, scrollThrottle: 30};
...
if ($("#gmap").length > 0) {
    (function (c, a, h, g) {
        var b, i, e;
        b = {
            activateCurrent: function (d) {
                this.html_element.find("select").val(d);
            }, getHtml: function () {
                var j = this, f = "", d;
                if (1 < this.ln) {
                    f += '<select class="dropdown controls ' + this.o.controls_cssclass + '">';
                    this.ShowOnMenu(this.view_all_key) && (f += '<option value="' + this.view_all_key + '">' + this.o.view_all_text + "</option>");
                    for (d = 0; d < this.ln; d += 1) {
                        this.ShowOnMenu(d) && (f += '<option value="' + (d + 1) + '">' + (this.o.locations[d].title || "#" + (d + 1)) + "</option>");
                    }
                    f = c(f + "</select>").bind("change", function () {
                        j.ViewOnMap(this.value);
                    });
                }
                (d = this.o.controls_title) && (d = c('<div class="controls_title"></div>').css(this.o.controls_applycss ? {
                    fontWeight: "bold",
                    fontSize: this.o.controls_on_map ? "12px" : "inherit",
                    padding: "3px 10px 5px 0"
                } : {}).append(this.o.controls_title));
                return this.html_element = c('<div class="wrap_controls"></div>').append(d).append(f);
            }
        };
        i = {
            html_a: function (k, f, d) {
                var j = this;
                f = f || k + 1;
                d = d || this.o.locations[k].title;
                k = c('<a data-load="' + f + '" id="ullist_a_' + f + '" href="#' + f + '" title="' + d + '"><span>' + (d || "#" + (k + 1)) + "</span></a>");
                k.css(this.o.controls_applycss ? {
                    color: "#666",
                    display: "block",
                    padding: "5px",
                    fontSize: this.o.controls_on_map ? "12px" : "inherit",
                ...
                k.on("click", function (l) {
                    l.preventDefault();
                    l = c(this).attr("data-load");
                    j.ViewOnMap(l);
                });
                return k;
            }, activateCurrent: function (d) {
                this.html_element.find("li").removeClass("active");
                this.html_element.find("#ullist_a_" + d).parent().addClass("active");
            }, getHtml: function () {
                var f = c("<ul class='ullist controls " + this.o.controls_cssclass + "'></ul>").css(this.o.controls_applycss ? {
                    margin: 0,
                    padding: 0,
                    listStyleType: "none"
                } : {}), d;
                this.ShowOnMenu(this.view_all_key) && f.append(c("<li></li>").append(i.html_a.call(this, !1, this.view_all_key, this.o.view_all_text)));
                for (d = 0; d < this.ln; d++) {
                    this.ShowOnMenu(d) && f.append(c("<li></li>").append(i.html_a.call(this, d)));
                }
                (d = this.o.controls_title) && (d = c('<div class="controls_title"></div>').css(this.o.controls_applycss ? {
                    fontWeight: "bold",
                    padding: "3px 10px 5px 0",
        ...
        e = function () {
            function d(f) {
                ...
                this.o = {
                    ...
                    controls_on_map: !0,
                    controls_applycss: !0,
                    controls_position: h.maps.ControlPosition.RIGHT_TOP,
                    type: "marker",
                    view_all: !0,
                    ...
                    locations: [],
                    commons: {},
                    map_options: {mapTypeId: h.maps.MapTypeId.ROADMAP, zoom: 1},
                    stroke_options: {
                        strokeColor: "#0000FF",
                        strokeOpacity: 0.8,
                        strokeWeight: 2,
                    ...
                    directions_options: {
                        travelMode: h.maps.TravelMode.DRIVING,
                        unitSystem: h.maps.UnitSystem.METRIC,
                        optimizeWaypoints: !1,
                    ...
                    beforeShow: function (j, k, l) {
                    },
                    afterShow: function (j, k, l) {
                    },
                    afterCreateMarker: function (j, k, l) {
                    },
                    beforeCloseInfowindow: function (j, k) {
                    },
                    afterCloseInfowindow: function (j, k) {
                    },
                    beforeOpenInfowindow: function (j, k, l) {
                    },
                    afterOpenInfowindow: function (j, k, l) {
                    },
                    afterRoute: function (j, k, l) {
                    },
                    onPolylineClick: function (j) {
                    }
                };
                this.AddControl("dropdown", b);
                this.AddControl("list", i);
                c.extend(!0, this.o, f);
            }

            d.prototype.controls = {};
            d.prototype.create_objMap = function () {
                var j = 0, f;
                for (f in this.o.styles) {
                    this.o.styles.hasOwnProperty(f) && (0 === j && (this.o.map_options.mapTypeControlOptions = {mapTypeIds: [h.maps.MapTypeId.ROADMAP]}), j++, this.o.map_options.mapTypeControlOptions.mapTypeIds.push("map_style_" + j));
                }
                if (this.loaded) {
                    ...
                    try {
                        this.map_div.css({
                            position: "relative",
                            overflow: "hidden"
                        }), this.canvas_map = c("<div>").addClass("canvas_map").css({
                            width: "100%",
                            height: "100%"
                        }).appendTo(this.map_div), this.oMap = new h.maps.Map(this.canvas_map.get(0), this.o.map_options);
                    } catch (k) {
                        this.errors.push(k.toString());
                    }
                }
                j = 0;
                for (f in this.o.styles) {
                    this.o.styles.hasOwnProperty(f) && (j++, this.oMap.mapTypes.set("map_style_" + j, new h.maps.StyledMapType(this.o.styles[f], {name: f})), this.oMap.setMapTypeId("map_style_" + j));
                }
                this.debug("01");
            };
            d.prototype.add_markers_to_objMap = function () {
                var f;
                f = this.o.type || "marker";
                switch (f) {
                    case"marker":
                        for (f = 0; f < this.ln; f++) {
                            this.create.marker.call(this, f);
                        }
                        break;
                    default:
                        this.create[f].apply(this);
                }
            };
            d.prototype.create = {
                marker: function (t) {
                    var s = this, p = this.o.locations[t], q, n, k, j, o = new h.maps.LatLng(p.lat, p.lon), f = !1 === p.visible ? !1 : !0;
                    c.extend(p, {
                        position: o,
                        map: this.oMap,
                        zIndex: 10000,
                        visible: !1 === this.o.show_markers ? !1 : f
                    });
                    p.image && (k = p.image_w || 32, j = p.image_h || 32, c.extend(p, {icon: new h.maps.MarkerImage(p.image, new h.maps.Size(k, j), new h.maps.Point(0, 0), new h.maps.Point(k / 2, j / 2))}));
                    q = new h.maps.Marker(p);
                    h.maps.event.addListener(q, "click", function () {
                        s.o.beforeShow(t, p, q);
                        n = !1 === p.show_infowindows ? !1 : !0;
                        s.o.show_infowindows && n && s.open_infowindow(t, q);
                        s.oMap.panTo(o);
                        p.zoom && s.oMap.setZoom(p.zoom);
                        s.current_control && (s.o.generate_controls && s.current_control.activateCurrent) && s.current_control.activateCurrent.call(s, t + 1);
                        s.current_index = t;
                        s.o.afterShow(t, p, q);
                    });
                    this.oBounds.extend(o);
                    this.markers.push(q);
                    this.o.afterCreateMarker(t, p, q);
                    p.visible = f;
                    return q;
                }, polyline: function () {
                    var j, f, k = [];
                    for (j = 0; j < this.ln; j++) {
                        f = new h.maps.LatLng(this.o.locations[j].lat, this.o.locations[j].lon), k.push(f), this.create.marker.call(this, j);
                    }
                    c.extend(this.o.stroke_options, {path: k, map: this.oMap});
                    this.Polyline ? this.Polyline.setOptions(this.o.stroke_options) : this.Polyline = new h.maps.Polyline(this.o.stroke_options);
                }, polygon: function () {
                    var j = this, f, k, l = [];
                    for (f = 0; f < this.ln; f++) {
                        k = new h.maps.LatLng(this.o.locations[f].lat, this.o.locations[f].lon), l.push(k), this.create.marker.call(this, f);
                    }
                    c.extend(this.o.stroke_options, {paths: l, editable: this.o.draggable, map: this.oMap});
                    this.Polygon ? this.Polygon.setOptions(this.o.stroke_options) : this.Polygon = new h.maps.Polygon(this.o.stroke_options);
                    h.maps.event.addListener(this.Polygon, "click", function (m) {
                        j.o.onPolylineClick(m);
                    });
                }, fusion: function () {
                    c.extend(this.o.fusion_options, {styles: [this.o.stroke_options], map: this.oMap});
                    this.Fusion ? this.Fusion.setOptions(this.o.fusion_options) : this.Fusion = new h.maps.FusionTablesLayer(this.o.fusion_options);
                }, directions: function () {
                    var o = this, j, s, p, q, n, f = [], r = 0;
                    for (j = 0; j < this.ln; j++) {
                        p = new h.maps.LatLng(this.o.locations[j].lat, this.o.locations[j].lon), 0 === j ? q = p : j === this.ln - 1 ? n = p : (s = !0 === this.o.locations[j].stopover ? !0 : !1, f.push({
                            location: p,
                            stopover: s
                        })), this.create.marker.call(this, j);
                    }
                    c.extend(this.o.directions_options, {origin: q, destination: n, waypoints: f});
                    this.directionsService || (this.directionsService = new h.maps.DirectionsService);
                    this.directionsDisplay ? this.directionsDisplay.setOptions({draggable: this.o.draggable}) : this.directionsDisplay = new h.maps.DirectionsRenderer({draggable: this.o.draggable});
                    this.directionsDisplay.setMap(this.oMap);
                    this.o.directions_panel && (this.o.directions_panel = c(this.o.directions_panel), this.directionsDisplay.setPanel(this.o.directions_panel.get(0)));
                    this.o.draggable && h.maps.event.addListener(this.directionsDisplay, "directions_changed", function () {
                        r = o.compute_distance(o.directionsDisplay.directions);
                        o.o.afterRoute(r);
                    });
                    this.directionsService.route(this.o.directions_options, function (k, l) {
                        l === h.maps.DirectionsStatus.OK && (r = o.compute_distance(k), o.directionsDisplay.setDirections(k));
                        o.o.afterRoute(r, l, k);
                    });
                }
            };
            d.prototype.compute_distance = function (j) {
                var f = 0, l = j.routes[0], k = l.legs.length;
                for (j = 0; j < k; j++) {
                    f += l.legs[j].distance.value;
                }
                return f;
            };
            d.prototype.type_to_open = {
                bubble: function (f) {
                    this.infowindow = new h.maps.InfoWindow({content: f.html || ""});
                }
            };
            d.prototype.open_infowindow = function (j, f) {
                this.CloseInfoWindow();
                var l = this.o.locations[j], k = l.type || this.o.infowindow_type;
                l.html && this.type_to_open[k] && (this.o.beforeOpenInfowindow(j, l, f), this.type_to_open[k].call(this, l), this.infowindow.open(this.oMap, f), this.o.afterOpenInfowindow(j, l, f));
            };
            d.prototype.get_html_controls = function () {
            ...
            d.prototype.generate_controls = function () {
                if (this.o.controls_on_map) {
                    var j = c('<div class="on_gmap ' + this.o.controls_type + ' gmap_controls"></div>').css(this.o.controls_applycss ? {margin: "5px"} : {}), f = c(this.get_html_controls()).css(this.o.controls_applycss ? {
                        background: "#fff",
                        padding: "5px",
                    ...
                    j.append(f);
                    this.oMap.controls[this.o.controls_position].push(j.get(0));
                } else {
                    this.controls_wrapper.empty(), this.controls_wrapper.append(this.get_html_controls());
                }
            };
            d.prototype.init_map = function () {
                var j = this, f = 0;
                ...
                if (this.markers) {
                    for (f in this.markers) {
                        if (this.markers[f]) {
                            try {
                                this.markers[f].setMap(null);
                            } catch (k) {
                                j.errors.push(k);
                            }
                        }
                ...
                this.o.controls_on_map && this.oMap.controls && this.oMap.controls[this.o.controls_position].forEach(function (l, n) {
                    try {
                        j.oMap.controls[this.o.controls_position].removeAt(n);
                    } catch (m) {
                        j.errors.push(m);
                    }
                });
                this.oBounds = new h.maps.LatLngBounds;
                this.debug("02");
            };
            d.prototype.perform_load = function () {
                1 === this.ln ? (this.oMap.setCenter(this.markers[0].getPosition()), this.ViewOnMap(1)) : 0 === this.ln ? (this.o.map_options.set_center ? this.oMap.setCenter(new h.maps.LatLng(this.o.map_options.set_center[0], this.o.map_options.set_center[1])) : this.oMap.fitBounds(this.oBounds), this.oMap.setZoom(this.o.map_options.zoom)) : (this.oMap.fitBounds(this.oBounds), "number" === typeof(this.o.start - 0) && 0 < this.o.start && this.o.start <= this.ln ? this.ViewOnMap(this.o.start) : this.ViewOnMap(this.view_all_key));
            };
            d.prototype.debug = function (f) {
                this.dev && this.errors.length && console.log(f + ": ", this.errors);
            };
            d.prototype.AddControl = function (j, f) {
                if (!j || !f) {
                    return !1;
                }
                this.controls[j] = f;
            ...
            d.prototype.ShowOnMenu = function (j) {
                if (j === this.view_all_key && this.o.view_all && 1 < this.ln) {
                    return !0;
                }
                j = parseInt(j, 10);
                if ("number" === typeof(j - 0) && 0 <= j && j < this.ln) {
                    var f = !1 === this.o.locations[j].on_menu ? !1 : !0;
                    if (!1 !== this.o.locations[j].visible && f) {
                        return !0;
                    }
                }
                return !1;
            };
            d.prototype.ViewOnMap = function (j) {
                if (j === this.view_all_key) {
                    this.o.beforeViewAll(), this.current_index = j, 0 < this.o.locations.length && (this.o.generate_controls && this.current_control && this.current_control.activateCurrent) && this.current_control.activateCurrent.apply(this, [j]), this.oMap.fitBounds(this.oBounds), this.CloseInfoWindow(), this.o.afterViewAll();
                } else {
                    if (j = parseInt(j, 10), "number" === typeof(j - 0) && 0 < j && j <= this.ln) {
                        try {
                            h.maps.event.trigger(this.markers[j - 1], "click");
                        } catch (f) {
                            this.errors.push(f.toString());
                        }
                    }
                }
                this.debug("03");
            };
            d.prototype.SetLocations = function (j, f) {
                this.o.locations = j;
                f && this.Load();
            };
            d.prototype.AddLocations = function (j, f) {
                var k = this;
                c.isArray(j) && c.each(j, function (m, l) {
                    k.o.locations.push(l);
                });
                c.isPlainObject(j) && this.o.locations.push(j);
                f && this.Load();
            };
            d.prototype.AddLocation = function (j, f, k) {
                c.isPlainObject(j) && this.o.locations.splice(f, 0, j);
                k && this.Load();
            };
            d.prototype.RemoveLocations = function (j, f) {
                var l = this, k = 0;
                c.isArray(j) ? c.each(j, function (n, m) {
                    m - k < l.ln && l.o.locations.splice(m - k, 1);
                    k++;
                }) : j < this.ln && this.o.locations.splice(j, 1);
                f && this.Load();
            };
            ...
            d.prototype._init = function () {
                ...
                for (var f = 0; f < this.ln; f++) {
                    c.extend(this.o.locations[f], this.o.commons), this.o.locations[f].html && (this.o.locations[f].html = this.o.locations[f].html.replace("%index", f + 1), this.o.locations[f].html = this.o.locations[f].html.replace("%title", this.o.locations[f].title || ""));
                }
                this.map_div = c(this.o.map_div);
                this.controls_wrapper = c(this.o.controls_div);
            };
            d.prototype.Load = function (j) {
                c.extend(!0, this.o, j);
                j && j.locations && (this.o.locations = j.locations);
                this._init();
                !1 === this.o.visualRefresh ? h.maps.visualRefresh = !1 : h.maps.visualRefresh = !0;
                this.init_map();
                this.create_objMap();
                ...
                if (this.loaded) {
                    ...
                    h.maps.event.addListenerOnce(this.oMap, "idle", function () {
                        f.perform_load();
                    });
                    h.maps.event.addListener(this.oMap, "resize", function () {
                        f.canvas_map.css({width: f.map_div.width(), height: f.map_div.height()});
                    });
                    for (var n in this.o.listeners) {
                        var l = this.oMap, m = this.o.listeners[n];
                        this.o.listeners.hasOwnProperty(n) && h.maps.event.addListener(this.oMap, n, function (k) {
                            m(l, k);
                        });
                    }
                }
...
!function (P, O) {
    ...
    var B = M.utils = {
        extend: function (b, h, g) {
            ...
            return {x: Math.abs(d / e) || 0, y: Math.abs(f / e) || 0};
    ...
    M.Instance = function (d, c) {
        ...
        on: function (e, d) {
            ...
            return B.each(f, function (b) {
                this.element.addEventListener(b, d, !1), this.eventHandlers.push({gesture: b, handler: d});
            }, this), this;
        }, off: function (g, f) {
            var j, i, h = g.split(" ");
    ...
    var A = null, z = !1, y = !1, x = M.event = {
        ...
        gestures: [], current: null, previous: null, stopped: !1, startDetect: function (d, c) {
    ...
    M.gestures.Drag = {
        ...
        name: "release", index: 1 / 0, handler: function (d, c) {
...
!function (e, d) {
    function f(b, g) {
        b.event.bindDom = function (h, c, a) {
            ...
            return i.has(c.target).length && (i = g(c.target)), i.trigger({type: h, gesture: c});
